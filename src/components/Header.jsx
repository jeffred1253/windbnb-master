...
import { Location, Guest, Reload } from './Research'
        ...
        <header className='header'>
            <div>
                ...
                <div className="search">
                    <div>
                        <div className="location" onClick={Location}><span>Helsinki, Finland</span></div>
                        <div className="guest"onClick={Guest}><span>Add guests</span></div>
                    </div>
                    <div className='loupe' onClick={Reload}>
                        <div>
                            <svg
